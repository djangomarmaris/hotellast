"""
Django's settings for hotel project.
...
SECRET_KEY = 'django-insecure-0+1cobbis6wx2j$*0t%5w4gj!v9m=cr8$vyi@$%$3a3ws+d%(r'
...
MODELTRANSLATION_FALLBACK_LANGUAGES = ("en","ru","tr")
